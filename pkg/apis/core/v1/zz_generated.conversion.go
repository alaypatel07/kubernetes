...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*corev1.DRADeviceFieldRef)(nil), (*core.DRADeviceFieldRef)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_DRADeviceFieldRef_To_core_DRADeviceFieldRef(a.(*corev1.DRADeviceFieldRef), b.(*core.DRADeviceFieldRef), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.DRADeviceFieldRef)(nil), (*corev1.DRADeviceFieldRef)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_DRADeviceFieldRef_To_v1_DRADeviceFieldRef(a.(*core.DRADeviceFieldRef), b.(*corev1.DRADeviceFieldRef), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_DRADeviceFieldRef_To_core_DRADeviceFieldRef(in *corev1.DRADeviceFieldRef, out *core.DRADeviceFieldRef, s conversion.Scope) error {
...
// Convert_v1_DRADeviceFieldRef_To_core_DRADeviceFieldRef is an autogenerated conversion function.
func Convert_v1_DRADeviceFieldRef_To_core_DRADeviceFieldRef(in *corev1.DRADeviceFieldRef, out *core.DRADeviceFieldRef, s conversion.Scope) error {
	return autoConvert_v1_DRADeviceFieldRef_To_core_DRADeviceFieldRef(in, out, s)
}

func autoConvert_core_DRADeviceFieldRef_To_v1_DRADeviceFieldRef(in *core.DRADeviceFieldRef, out *corev1.DRADeviceFieldRef, s conversion.Scope) error {
	out.ClaimName = in.ClaimName
	out.RequestName = in.RequestName
	out.Attribute = in.Attribute
	return nil
...
// Convert_core_DRADeviceFieldRef_To_v1_DRADeviceFieldRef is an autogenerated conversion function.
func Convert_core_DRADeviceFieldRef_To_v1_DRADeviceFieldRef(in *core.DRADeviceFieldRef, out *corev1.DRADeviceFieldRef, s conversion.Scope) error {
	return autoConvert_core_DRADeviceFieldRef_To_v1_DRADeviceFieldRef(in, out, s)
}
...
func autoConvert_v1_DownwardAPIVolumeFile_To_core_DownwardAPIVolumeFile(in *corev1.DownwardAPIVolumeFile, out *core.DownwardAPIVolumeFile, s conversion.Scope) error {
	...
	out.DRADeviceFieldRef = (*core.DRADeviceFieldRef)(unsafe.Pointer(in.DRADeviceFieldRef))
	return nil
}
...
func autoConvert_core_DownwardAPIVolumeFile_To_v1_DownwardAPIVolumeFile(in *core.DownwardAPIVolumeFile, out *corev1.DownwardAPIVolumeFile, s conversion.Scope) error {
	...
	out.Mode = (*int32)(unsafe.Pointer(in.Mode))
	out.DRADeviceFieldRef = (*corev1.DRADeviceFieldRef)(unsafe.Pointer(in.DRADeviceFieldRef))
	return nil
}
