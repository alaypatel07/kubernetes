...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DRADeviceFieldRef) DeepCopyInto(out *DRADeviceFieldRef) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DRADeviceFieldRef.
func (in *DRADeviceFieldRef) DeepCopy() *DRADeviceFieldRef {
	if in == nil {
		return nil
	}
	out := new(DRADeviceFieldRef)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DownwardAPIVolumeFile) DeepCopyInto(out *DownwardAPIVolumeFile) {
	*out = *in
	...
	if in.DRADeviceFieldRef != nil {
		in, out := &in.DRADeviceFieldRef, &out.DRADeviceFieldRef
		*out = new(DRADeviceFieldRef)
		**out = **in
	}
	return
