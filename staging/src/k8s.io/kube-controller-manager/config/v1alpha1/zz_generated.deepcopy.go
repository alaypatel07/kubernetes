...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CronJobControllerV2Configuration) DeepCopyInto(out *CronJobControllerV2Configuration) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CronJobControllerV2Configuration.
func (in *CronJobControllerV2Configuration) DeepCopy() *CronJobControllerV2Configuration {
	if in == nil {
		return nil
	}
	out := new(CronJobControllerV2Configuration)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KubeControllerManagerConfiguration) DeepCopyInto(out *KubeControllerManagerConfiguration) {
	*out = *in
	...
	out.CronJobControllerV2 = in.CronJobControllerV2
