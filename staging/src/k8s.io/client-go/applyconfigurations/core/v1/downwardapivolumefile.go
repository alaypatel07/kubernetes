...
func (b *DownwardAPIVolumeFileApplyConfiguration) WithDRADeviceFieldRef(value *DRADeviceFieldRefApplyConfiguration) *DownwardAPIVolumeFileApplyConfiguration {
